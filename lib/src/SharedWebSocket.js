...
class SharedWebSocket {
    constructor(url, timeout) {
        ...
        let worker_blob = new Blob([webSocketWorker]);
        ...
        this.WebSocketWorker.port.onmessage = (obj) => {
            //console.log('=================', obj);
            this._procOnMessage(obj.data)
        };
        ...
        if (!!obj.tag) {
            ...
            switch (obj.event) {
                ...
                case "onclose":
                    ...
                    break;
                case "onconnect"://与sharedworker连接成功
